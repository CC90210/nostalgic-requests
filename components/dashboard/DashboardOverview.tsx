...
export default function DashboardOverview({ user, stats, djName, phone }: DashboardOverviewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] p-6 md:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard icon={<Users className="w-6 h-6" />} value={phone || "-"} label="Your Phone" color="blue" />
      </div>
